...
describe(`Check time changer`, () => {
  ...
  it(`Should not allow set negative values`, () => {
    ...
    assert.throws(() => changeTime(INITIAL_GAME, -10).time, /Time should not be negative value/);
    assert.throws(() => changeTime(INITIAL_GAME, -Infinity).time, /Time should not be negative value/);
  });
